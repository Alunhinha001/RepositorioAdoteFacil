    ...
    <form action="../PHP/Usuario/cadastrarUser.php" method="post" enctype="multipart/form-data">
      <fieldset>
        ...
        <div class="inputBox">
          ...
          <input type="text" name="nomeDoador" id="nome" class="inputUser" required>
        </div>
        ...
        <div class="inputBox">
          ...
          <input type="tel" name="whats" id="whats" class="inputUser" required>
        </div>
        ...
        <p class="link-secundario">
            <a href="cadastropet.html">Procurando cadastro de pet?</a>
        </p>
