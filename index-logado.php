...
<body>
	...
	<main>
            ...
            <div class="slides-container">
                <div class="slide ativo">
                  ...
                  <div class="slide-texto">
                      ...
                      <a href="adote.html" class="btn-slide">Adotar agora</a>
                  </div>
                </div>
                <div class="slide">
		...
		<section class="cards-vitrini">
            <h1>Conheça alguns dos animais disponíveis</h1>
			<div class="vitrine">
				<!-- seus cards de animais -->
			</div>
            <nav class="vejamais">
                <a href="adote.html">Veja mais <br><img src="images/index/Seta-cinza.png" alt=""></a>
            </nav>
		</section>
	</main>
